          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div>
              <div className="mb-1 flex items-center justify-between">
                <label htmlFor="auth-password" className="text-xs font-medium text-app-text-muted">
                  Password
                </label>
                {flow === 'signin' && (
                  <button
                    ...
                    className="cursor-pointer text-xs text-app-text-muted hover:text-app-black transition-colors"
                  >
                    Forgot password?
                  </button>
                )}

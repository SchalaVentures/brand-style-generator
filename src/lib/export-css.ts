...
:root {
  ...
  --color-on-primary: ${lightPalette.onPrimary};
  --color-on-secondary: ${lightPalette.onSecondary};
  --color-on-tertiary: ${lightPalette.onTertiary};
  --color-on-accent: ${lightPalette.onAccent};
...
@media (prefers-color-scheme: dark) {
  :root:not([data-theme="light"]) {
    ...
    --color-tertiary: ${darkPalette.tertiary};
    --color-accent: ${darkPalette.accent};
    --color-on-primary: ${darkPalette.onPrimary};
    --color-on-secondary: ${darkPalette.onSecondary};
    --color-on-tertiary: ${darkPalette.onTertiary};
    --color-on-accent: ${darkPalette.onAccent};
    --color-bg: ${darkPalette.bg};
    --color-surface: ${darkPalette.surface};
    --color-surface-raised: ${darkPalette.surfaceRaised};
    --color-border: ${darkPalette.border};
